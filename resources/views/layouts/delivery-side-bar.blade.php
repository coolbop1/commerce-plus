    ...
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="p-4 text-center mb-4 border-bottom position-relative">
            ...
            <span class="avatar avatar-md mb-3">
                                    <img src="/{{ $delivery_boy->image }}"
                        onerror="this.onerror=null;this.src='/assets/img/avatar-place.png';">
                            </span>
            <!-- Name -->
            <h4 class="h5 fs-14 mb-1 fw-700 text-dark">{{ ucwords($user->name) }}</h4>
            <!-- Phone -->
                            <div class="text-truncate opacity-60 fs-12">{{ $delivery_boy->phone }}</div>
            <!-- Email -->
                    </div>
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="/delivery/assigned-deliveries"
                        ...
                        <span class="aiz-side-nav-text ml-3">Assigned Delivery</span>
                    </a>
                </li>
                <!-- Pickup Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="/delivery/pickup-deliveries"
                        ...
                        <span class="aiz-side-nav-text ml-3">Picked Up Delivery</span>
                    </a>
                </li>
                <!-- On The Way Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="/delivery/on-the-way-deliveries"
                        ...
                        <span class="aiz-side-nav-text ml-3">On The Way Delivery</span>
                    </a>
                </li>
                <!-- Pending Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="/delivery/pending-deliveries"
                        ...
                        <span class="aiz-side-nav-text ml-3">Pending Delivery</span>
                    </a>
                </li>
                <!-- Completed Delivery -->
                <li class="aiz-side-nav-item">
                    <a href="/delivery/completed-deliveries"
                        ...
                        <span class="aiz-side-nav-text ml-3">Completed Delivery</span>
                    </a>
                </li>
                <!-- Cancelled Delivery -->
                <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="/delivery/total-collections"
                        ...
                        <span class="aiz-side-nav-text ml-3">Total Collection</span>
                    </a>
                </li>
                <!-- Total Earnings -->
                <li class="aiz-side-nav-item">
                    <a href="/delivery/total-earnings"
                        ...
                        <span class="aiz-side-nav-text ml-3">Earnings</span>
                    </a>
                </li>
                <!-- Manage Profile -->
                <li class="aiz-side-nav-item">
            ...
            <!-- logout -->
            <a style="cursor: pointer; color: white" onclick="return logout()" class="btn btn-primary btn-block fs-14 fw-700 mb-5 mb-md-0" style="border-radius: 25px;">Sign Out</a>
        </div>
