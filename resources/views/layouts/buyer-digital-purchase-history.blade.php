@section('buyer-digital-purchase-history')
        ...
        <table class="table aiz-table mb-0">
            ...
            <tbody class="fs-14">
                ...
                @endphp
                    <tr>
                        <td class="pl-0">
                            <a href="/product/{{ $product->slug }}" class="d-flex align-items-center">
                        ...
                        <td class="pr-0 text-right" style="vertical-align: middle;">
                            <a class="btn btn-soft-info btn-icon btn-circle btn-sm hov-svg-white" href="/{{ $product->files }}" title="Download">
