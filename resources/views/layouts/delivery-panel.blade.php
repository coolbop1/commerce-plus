...
<div class="aiz-user-panel">
    ...
    <div class="row align-items-center">
        <div class="col-6">
            <h1 class="fs-20 fw-700 text-dark">Dashboard</h1>
        </div>
        <div class="col-6 text-right">
            <p class="fs-14 fw-400 text-dark mb-0">{{ Carbon\Carbon::parse(now())->format('d M, Y') }}</p>
            <small class="fs-12 fw-400 text-secondary">{{ Carbon\Carbon::parse(now())->format('D') }}</small>
        </div>
    </div>
    </div>
    ...
    <!-- Pending Delivery -->
        ...
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400">Pending Delivery</p>
                <h4 class="mb-0 fs-24 fw-700">{{ $pending_deliveries->count() }}</h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 py-3">
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400">Total Collected ({{ Carbon\Carbon::parse(now())->format('M') }})</p>
                <h4 class="mb-0 fs-24 fw-700">{{ $delivery_boy->deliveries()->whereHas('order', function($q) { $q->where('status', 'completed'); })->where('delivery_type', 'home_delivery')->whereBetween('created_at',[$current_month_start, $current_month_end])->count() }}</h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 py-3">
        <div class="d-flex align-items-center py-5 px-4 bg-dark border">
          <span style="position: relative"><span style="color: white; font-size: 30px; position:absolute; right: -45px; top: -20px">₦</span></span>
            <svg xmlns="http://www.w3.org/2000/svg" width="66.002" height="65.997" viewBox="0 0 66.002 65.997">
                <g id="Group_25732" data-name="Group 25732" transform="translate(-1173.998 -382.001)">
                  ...
                  <path  d="m 142.97352,126.54448 -16.42904,0 0,73.45552 -29.73526,0 -26.476605,-73.45552 -29.192153,0 0,73.45552 -24.983031,0 0,-73.45552 -16.157431,0 0,-15.75017 16.157431,0 0,-22.81059 -16.157431,0 0,-15.88602 16.157431,0 0,-72.0977 29.735262,0 26.06925,72.0977 29.599507,0 0,-72.0977 24.98303,0 0,72.0977 16.42904,0 0,15.88602 -16.42904,0 0,22.81059 16.42904,0 0,15.75017 z M 50.373418,72.0977 41.140462,46.84316 l 0,25.25454 9.232956,0 z m 51.188032,38.69661 0,-22.81059 -24.032564,0 8.68975,22.81059 15.342814,0 z m -37.067189,0 -8.010887,-22.81059 -15.342912,0 0,22.81059 23.353799,0 z m 37.067189,41.95518 0,-26.20501 -9.77597,0 9.77597,26.20501 z" />

                 </g>
            </svg>

{{-- <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"  width="66.002" height="65.997" viewBox="0 0 66.002 65.997">
  <g id="Group_25732" data-name="Group 25732" transform="translate(-1173.998 -382.001)">
    <path id="Subtraction_214" data-name="Subtraction 214" d="M16445-2274a32.784,32.784,0,0,1-12.844-2.594,32.9,32.9,0,0,1-10.49-7.073,32.909,32.909,0,0,1-7.074-10.49A32.781,32.781,0,0,1,16412-2307a32.778,32.778,0,0,1,2.594-12.844,32.894,32.894,0,0,1,7.074-10.488,32.9,32.9,0,0,1,10.49-7.071A32.792,32.792,0,0,1,16445-2340a32.792,32.792,0,0,1,12.844,2.593,32.9,32.9,0,0,1,10.49,7.071,32.86,32.86,0,0,1,7.072,10.488A32.778,32.778,0,0,1,16478-2307a32.781,32.781,0,0,1-2.594,12.845,32.878,32.878,0,0,1-7.072,10.49,32.9,32.9,0,0,1-10.49,7.073A32.784,32.784,0,0,1,16445-2274Zm0-64a30.8,30.8,0,0,0-12.066,2.436,30.935,30.935,0,0,0-9.855,6.643,30.928,30.928,0,0,0-6.643,9.854A30.8,30.8,0,0,0,16414-2307a30.8,30.8,0,0,0,2.436,12.067,30.923,30.923,0,0,0,6.643,9.855,30.931,30.931,0,0,0,9.855,6.645A30.8,30.8,0,0,0,16445-2276a30.8,30.8,0,0,0,12.066-2.437,30.9,30.9,0,0,0,9.854-6.645,30.917,30.917,0,0,0,6.643-9.855A30.8,30.8,0,0,0,16476-2307a30.8,30.8,0,0,0-2.436-12.066,30.916,30.916,0,0,0-6.643-9.854,30.9,30.9,0,0,0-9.854-6.643A30.812,30.812,0,0,0,16445-2338Z" transform="translate(-15238 2722)" fill="#008ac3" opacity="0.2"/>
    <rect id="Rectangle_19503" data-name="Rectangle 19503" width="52" height="52" rx="26" transform="translate(1181 389)" fill="#0088be"/>
    ...
    <path d="M13.42,0H32.1a1.25,1.25,0,0,1,1,.6L58,42.26H83.17v-41A1.23,1.23,0,0,1,84.39,0h17.28a1.23,1.23,0,0,1,1.23,1.23v41h11a1.23,1.23,0,0,1,1.23,1.23V54.55a1.23,1.23,0,0,1-1.23,1.23h-11v9.41h11a1.23,1.23,0,0,1,1.23,1.22V77.48a1.23,1.23,0,0,1-1.23,1.22h-11v43a1.23,1.23,0,0,1-1.23,1.23H84.39a1.25,1.25,0,0,1-1-.6L58,78.7H33.26v43A1.23,1.23,0,0,1,32,122.88H13.42a1.23,1.23,0,0,1-1.23-1.23V78.7h-11A1.23,1.23,0,0,1,0,77.48V66.41a1.23,1.23,0,0,1,1.23-1.22h11V55.78h-11A1.23,1.23,0,0,1,0,54.55V43.49a1.23,1.23,0,0,1,1.23-1.23h11v-41A1.23,1.23,0,0,1,13.42,0ZM33.26,55.78v9.41h17l-4.4-9.41ZM70,65.19H83.17V55.78H65.68L70,65.19ZM83.17,78.7H77.88l5.29,11v-11ZM33.26,32.76v9.5h4.57l-4.57-9.5Z"/>
            ...
            <div class="text-white ml-3">
                <p class="mb-2 fs-14 fw-400">Earnings</p>
    ...
    <!-- Cancelled Delivery -->
        ...
        <div class="d-flex align-items-center p-4 bg-primary">
            ...
            <p class="mb-0 fs-14 fw-700 text-white ml-3">Cancelled Delivery</p>
    ...
    <div class="col-md-4 py-3">
        <a href="/delivery/on-the-way-deliveries" class="d-flex flex-column align-items-center py-4 py-lg-5 border bg-light has-transition hov-bg-soft-light">
            ...
            <span class="mb-0 mt-3 fs-14 fw-700 text-primary">On The Way Deliveries</span>
        </a>
    </div>
    
    <!-- Picked Up Deliveries -->
    <div class="col-md-4 py-3">
        <a href="/delivery/pickup-deliveries" class="d-flex flex-column align-items-center py-4 py-lg-5 border bg-light has-transition hov-bg-soft-light">
            ...
            <span class="mb-0 mt-3 fs-14 fw-700 text-warning">Picked Up Deliveries</span>
        </a>
    </div>
    
    <!-- Assigned Deliveries -->
    <div class="col-md-4 py-3">
        <a href="/delivery/assigned-deliveries" class="d-flex flex-column align-items-center py-4 py-lg-5 border bg-light has-transition hov-bg-soft-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70">
            ...
            <span class="mb-0 mt-3 fs-14 fw-700" style="color: #0084b4;">Assigned Deliveries</span>
        </a>
    </div>
