...
<div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
    ...
    <div class="p-4 text-center mb-4 border-bottom position-relative">
        ...
        <span class="avatar avatar-md mb-3">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/yPtFPf8AMEt5YELKpvQ3IjQTVPZKa49hBnT4Zdqa.png"
                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/avatar-place.png';">
                        </span>
        <!-- Name -->
        <h4 class="h5 fs-14 mb-1 fw-700 text-dark">Wilma P. Hughes</h4>
        <!-- Phone -->
                        <div class="text-truncate opacity-60 fs-12">706-482-6350</div>
        <!-- Email -->
                </div>
