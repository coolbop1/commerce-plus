        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                <li class="aiz-side-nav-item">
                    <a href="https://demo.activeitzone.com/ecommerce/seller/dashboard" class="aiz-side-nav-link">
                ...
                <li class="aiz-side-nav-item">
                    <a href="https://demo.activeitzone.com/ecommerce/seller/shop"
                        class="aiz-side-nav-link ">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
                ...
                class="card mb-0  px-4 py-5  d-flex align-items-center justify-content-center">
                                    <div class="my-2 py-1">
                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/verified.png" alt="" width="">
                    </div>
                            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                ...
                <a href="https://demo.activeitzone.com/ecommerce/seller/shop" class="btn btn-primary">
                    Go to setting
                </a>
            </div>
        </div>
                ...
                data-md-items="3" data-sm-items="2" data-arrows='true'>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/nike-men-mercurial-superfly-7-elite-firm-ground-football-shoe-qsdro"
                                        class="d-block text-reset">Nike Men &#039;Mercurial Superfly 7 Elite Firm Ground Football Shoe</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/nike-men-mercurial-superfly-7-elite-firm-ground-football-shoe-zlwgn"
                                        class="d-block text-reset">Under Armour Men&#039;s Charged Assert 9 Running Shoe</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/latest-coat-pant-designs-white-wedding-suits-for-men-sq38a"
                                        class="d-block text-reset">HP Stream 9VK97UA#ABA 14 inches HD(1366x768) Display</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/soft-bamboo-boxers-for-men-cool-comfortable-breathable-mens-underwear-boxer-shorts-4i89i"
                                        class="d-block text-reset">Rb3030 Outdoorsman I Aviator Sunglasses</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/sungait-ultra-lightweight-rectangular-polarized-sunglasses-uv400-protection-1szdb"
                                        class="d-block text-reset">SUNGAIT Ultra Lightweight Rectangular Polarized Sunglasses UV400 Protection</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/jacket-blue-plain-washington-flcm7"
                                        class="d-block text-reset">Calvin Klein Men&#039;s Slim Fit Suit Separates</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/polar-mens-waterproof-outsole-deep-tread-fully-faux-fur-lined-winter-durable-snow-boots-8kcm2"
                                        class="d-block text-reset">POLAR Mens Waterproof Outsole Deep Tread Fully Faux Fur Lined Winter Durable Snow Boots</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/Rain-Coats-for-Adults-Rain-Ponchos-with-Hoods-Man-rhSJD"
                                        class="d-block text-reset">Rain Coats for Adults Rain Ponchos with Hoods Man</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/timberland-mens-classic-leather-jean-belt-93uoq"
                                        class="d-block text-reset">Timberland Men&#039;s Classic Leather Jean Belt</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/casual-garb-mens-snow-heather-fitted-t-shirt-short-sleeve-crew-neck-t-shirts-for-men-pxcim"
                                        class="d-block text-reset">Casual Garb Men&#039;s Snow Heather Fitted T Shirt Short Sleeve Crew Neck T-Shirts for Men</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/Lee-Mens-Slim-Straight-Jean-wUDEU"
                                        class="d-block text-reset">Lee Men&#039;s Slim Straight Jean</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/microsoft-365-personal--12-month-subscription-1-person-premium-office-apps-68431"
                                        class="d-block text-reset">Microsoft 365 Personal | 12-Month Subscription, 1 person| Premium Office Apps</a>
                                </h3>
                            </div>
                        </div>
                    </div>
